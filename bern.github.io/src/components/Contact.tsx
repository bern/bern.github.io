export const Contact = () => {
    return (
        <div>
            ...
            <p><a href="https://linkedin.com/in/berniemarger" target="_blank">LinkedIn @berniemarger</a></p>
            <p><a href="mailto:bern422@gmail.com" target="_blank">Email bern422@gmail.com</a></p>
        </div>
    );
}